...
- [CREATE-ACTIVE-TASK](_skills/CREATE-ACTIVE-TASK/SKILL.md)
- [BUILD-REPO-MAP](_skills/BUILD-REPO-MAP/SKILL.md)
- [INIT-KNOWLEDGE-BASE](_skills/INIT-KNOWLEDGE-BASE/SKILL.md)
- [UPDATE-KNOWLEDGE-BASE](_skills/UPDATE-KNOWLEDGE-BASE/SKILL.md)
- [UPDATE-HUMAN-DOCS](_skills/UPDATE-HUMAN-DOCS/SKILL.md)
- [UPDATE-README](_skills/UPDATE-README/SKILL.md)
- [FIX-FAILING-TEST](_skills/FIX-FAILING-TEST/SKILL.md)
- [ADD-FEATURE](_skills/ADD-FEATURE/SKILL.md)
- [SAFE-REFACTOR](_skills/SAFE-REFACTOR/SKILL.md)
- [REVIEW-DOC](_skills/REVIEW-DOC/SKILL.md)
- [CLOSE-TASK](_skills/CLOSE-TASK/SKILL.md)
- [SYNC-COMMANDS](_skills/SYNC-COMMANDS/SKILL.md)
