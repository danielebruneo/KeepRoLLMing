...
2. **Select Appropriate Location**: Based on the type of information:
   ...
   - For environmental/LLM/tool patterns: Save to `_agent/knowledge/ENVIRONMENT.md`
...
- "Remember environment quirks: HTTPX exception handling in nested scopes"

## Key Memory Locations by Scope:
- `.catalyst/_skills/REMEMBER/SKILL-REMEMBER.md` - Documentation location for this skill (this file)
