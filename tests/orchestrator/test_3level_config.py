...
import pytest
from keeprollming.routing import Route, DefaultSettings, ModelConfig
...
class TestThreeLevelHierarchy:
    ...
    def test_defaults_only(self):
        ...
        route = Route(
            name="test",
            pattern="test/*",
            model="unknown-model",  # Not in models config
            ctx_len=None,  # type: ignore
    ...
    def test_model_not_found_falls_back_to_defaults(self):
        ...
        route = Route(
            name="test",
            pattern="test/*",
            model="unknown-model",  # Not in config
            ctx_len=None,  # type: ignore
            max_tokens=None,  # type: ignore
        )
    ...
    def test_route_override_with_unknown_model(self):
        ...
        route = Route(
            name="test",
            pattern="test/*",
            model="unknown-model",  # Not in models_config
