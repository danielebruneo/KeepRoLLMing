...
2. **Select Appropriate Location**: Based on the type of information:
   - For project-specific insights and patterns: Save to `keeprollming/_agent/knowledge/MEMORY.md`
...
- `_skills/REMEMBER.md` - Documentation location for this skill (this file)
- `keeprollming/_agent/knowledge/MEMORY.md` - Project-specific implementation insights
