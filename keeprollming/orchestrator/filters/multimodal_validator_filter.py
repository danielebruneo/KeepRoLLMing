...
@register_filter("multimodal_validator")
class MultimodalValidatorFilter(Filter):
    ...
    Configuration (from filter_chain config):
    ...
    def __init__(self, config=None):
        ...
        try:
            self._logger_impl = __import__(
                "keeprollming.logging", fromlist=["get_filter_logger"]
            ).get_filter_logger("multimodal_validator")
        except Exception:
            self._logger_impl = None
