...
def build_routes_by_name(config: dict, include_private: bool = False) -> dict[str, Route]:
    ...
    return {route.name: route for route in user_routes}
...
def cmd_healthcheck(args):
    ...
    public_routes_by_name = build_routes_by_name(config, include_private=False)
