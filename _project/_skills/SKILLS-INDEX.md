...
- **[BUILD-AGENT-MAP]**(.catalyst/_skills/BUILD-AGENT-MAP/SKILL.md) - Populate [`_agent/knowledge/MAP.md`](../../_agent/knowledge/MAP.md) with an agent navigation guide for the CATALYST framework and project structure.
